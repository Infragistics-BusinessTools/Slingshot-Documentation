...
Slingshot private chat will be soon available so everyone can communicate with one or several users at once. You'll be able to have multiple conversations going on at the same time, while mixing in text formatting, attachments, emojis, and links. A feature that boosts productivity and enables swift collaboration between team members.

...
2.  **Add parameters' values**. In the following screen specify the
    ...
    <img src="images/REST-API-Data-Format-Result.png" alt="REST-API-Data-Format-Result\_All" width="75%" class="responsive-img"/>
...
4.  A **Body**: an optional message (when using *POST* and *PUT* methods) containing data

    <img src="images/Working-With-Methods.png" alt="Working With Methods" width="75%" class="responsive-img"/>

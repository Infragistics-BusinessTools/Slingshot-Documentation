...
If you want to additionally edit what *Marketo* objects other users can see and work with, click/tap the _Switch to advanced info edition_ button. Find more information about this in the [Editing the information for a data source](data-sources-advanced-editor.md) topic.  

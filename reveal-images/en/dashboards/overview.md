...
### The Dashboard Creation Process
  ...
  - **Prepare the data** to be used in your dashboard. Here is a quick overview of [how to work with spreadsheets](~/en/datasources/working-files/working-with-spreadsheets.md) in Analytics.

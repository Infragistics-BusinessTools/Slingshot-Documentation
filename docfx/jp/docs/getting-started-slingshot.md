...
- **[ブックマーク](https://www.slingshotapp.io/en/help/docs/bookmarks)**: Slingshot でブックマークを作成すると、重要なドキュメント、ダッシュボード、会話などをワンクリックで保存できます。  
...
- **Emily**: Slingshot のパーソナル AI アシスタントには、オンボードのヒントやコツ、ガイドやツアーがあり、Slingshot の旅をサポートします。パーソナル AI アシスタントを開くと、[**ヒント**] と [**その他のヘルプ**] の 2 つのセクションが表示されます。
   - **ヒント**: [**ツアーを見る**] をクリックすると、機能の簡潔な要約が表示され、Slingshot の概要を確認できます。

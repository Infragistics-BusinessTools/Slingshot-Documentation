...
2. 表示されるドロップダウンから、既存のフィールドのオン/オフを切り替えたり、タスク リストに新しいフィールドを作成したりできます。カスタム フィールドを作成するには、**[+ フィールドの追加]** をクリックまたはタップします。
...
<img src="../images/task-types-fields-remove-option.png" alt="List of different fields in a task with a type" class="responsive-img" width="85%" />
...
1. 親タスクのオーバーフロー メニューから **[フィールドの管理]** を選択します。 

...
<img src="images/create-dashboard.png" alt="Dashboard button in My Analytics" class="responsive-img" width="80%" />
...
<img src="images/see-all-templates-dashboard-option.png" alt="See All Templates option for dashboards" class="responsive-img" width="80%" />

3. **[新しい表示形式]** ダイアログが表示されます。データ ソースを使用しながら表示形式を作成することができます。

<img src="images/new-visualization-screen.png" alt="A list of already added data sources" class="responsive-img" width= "80%"/>
...
<img src="images/select-your-data-source.png" alt="List with some of the data sources" class="responsive-img" width="80%"/>

データ ソースがコンテンツ マネージャーのスプレッドシートの場合、表示形式で使用する特定のシートを選択できます。

<img src="images/dashboards-select-data-sheet.png" alt="Excel file with a list of sheets" class="responsive-img" width="80%" />
...
<img src="images/create-dashboards-chart-types.png" alt="Chart types list"  class="responsive-img" width="80%"/>

表示形式にラベルと値を追加し、右側のペインでプレビューします。必要に応じて、表示形式設定を変更してフィルターを追加できます。

<img src="images/visualization-editor-sample-data.png" alt="Preview of a isualization fields editor" class="responsive-img" width="80%" />
...
<img src="images/dashboard-themes-option.png" alt="A list of different dashboard theme" class="responsive-img" width="80%" />
...
<img src="images/create-dashboard-save-as-dialog.png" alt="Save as dialog while creating dashboards" class="responsive-img" width="80%" />

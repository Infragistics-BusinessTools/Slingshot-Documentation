...
<img src="images/export-pdf-options.png" alt="Settings for PDF document in the Export Dashboard menu" class="responsive-img" width="60%"/>
...
3.  **[ブランディング]** 設定オプションの管理では、以下を選択できます。
    ...
    2.  **[カラー]** (PDF 文書のメイン カラー) とフッターで表示される会社の **[ロゴ]** - ここでは、次のオプションのいずれかを選択できます:
        ...
        - **ユーザーの組織 / ワークスペース** - 組織とすべてのワークスペースのブランディング (カラーとロゴ) が設定しているオプションとして表示されます。ワークスペースのブランディング設定にアクセス/変更する方法については、[ワークスペースの管理](../../../workspaces.md)トピックをご覧ください。
...
6.  **鉛筆アイコン**をクリックまたはタップして、選択したページに**注釈**を付けます。**注釈設定**の詳細については、[注釈画像](./export-as-images.md#注釈画像)を参照してください。

...
<table class="tg">
  ...
  <tr>
    <td class="tg-cly1" rowspan="2"><span style="font-weight:bold">false</span>: <span class="gray-snippet-cstm">false</span> は論理値の <span style="font-weight:bold">false</span> である 0 を返します。</td>
  ...
  <tr>
    <td class="tg-0lax" rowspan="2">true: <span class="gray-snippet-cstm">true</span> は論理値の <span style="font-weight:bold">true</span> である 1 を返します。</td>
...
| 関数名 | Logical Test                           | Value if true | Value if false |
| ------------- | -------------------------------------- | ------------- | -------------- |
| **if** (…​)   | `[BirthDate]<date(1971,04,15,4,06,55)` | `1`           | `0`            |
...
[ルールでフィルターする](../../fields/field-filters-rules.md#ルールでフィルタリング)または[値を選択する](../../fields/field-filters-rules.md#値の選択) 1.00 を適用した場合のみ 2 つの行を確認します。

...
<table class="tg">
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">concatenate("Getting started"," with"," the"," Analytics"," application")</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">find("with","Getting Started with Analytics visualizations",3)</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">len("Getting Started with Analytics")</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">lower("Getting Started with Analytics")</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">mid("Getting Started with Analytics",9,12)</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">replace("Getting Started with Analytics","Getting Started","Creating Visualizations with")</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">trim(" Getting Started with Analytics ")</span></td>
  </tr>
  <tr>

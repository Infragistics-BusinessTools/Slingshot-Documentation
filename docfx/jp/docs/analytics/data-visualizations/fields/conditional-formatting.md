...
条件付き書式を使用して数値列の値に応じて、セル (または[テキス トビュー](../../data-visualizations/visualization-types/text-view.md)) の行に異なる書式を設定できます。たとえば、グリッドの下位 50% 範囲内の値は、非常に低い値を通知する赤色のアドナーで色を付けることができます。
...
条件付き書式は、以下の表示形式に適用できます。
  ...
  - [グリッド チャート](../../data-visualizations/visualization-types/grid-chart.md)

  - [ピボット チャート](../../data-visualizations/visualization-types/pivot-table.md)

  - [テキスト ビュー](../../data-visualizations/visualization-types/text-view.md)

>[!NOTE]
>[KPI](../../data-visualizations/visualization-types/kpi-gauge.md)、[リニア](../../data-visualizations/visualization-types/gauge-charts.md#リニア-ゲージ)、[円型](../../data-visualizations/visualization-types/gauge-charts.md#円型ゲージ)、[テキスト](../../data-visualizations/visualization-types/gauge-charts.md#テキスト-ゲージ)、および[ブレット グラフ](../../data-visualizations/visualization-types/gauge-charts.md#ブレット-グラフ) ゲージは、[**表示形式バンドの範囲の構成**](../../data-visualizations/visualization-types/gauge-charts.md#バンドの構成)で条件付き書式をサポートします。

...
1. **制限**を設定します。これらの値は自動的に指定された値の列のデータセット内の最大値/最小値として設定されますが、定数値を使用して手動でオーバーライドすることができます。

2. **[条件付き書式](https://slingshotapp.io/ja/help/docs/analytics/data-visualizations/fields/conditional-formatting)**を構成します。

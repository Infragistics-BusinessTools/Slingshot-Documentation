...
<img src="images/kpi-gauge-visualization-example.png" alt="KPI Gauge visualization example" class="responsive-img" width="85%"/>

**カテゴリ**を追加すると、1 つの表示形式に複数の KPI を含めることもできます。

<img src="images/multiple-kpi-gauges.png" alt="Multiple KPI Gauges" class="responsive-img" width="85%"/>
...
<img src="images/kpi-gauge-settings.png" alt="Advanced Settings KPI Gauge" class="responsive-img" width="85%"/>

...
7.**データ フィルター** プレースホルダーでフィールドを選択すると、フィルターを追加できます **(オプション)**。 
...
<img src="images/color-choropleth-map-example.png" alt="A choropleth map using the color category" class="responsive-img" width="80%"/>

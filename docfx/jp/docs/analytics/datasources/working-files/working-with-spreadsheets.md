...
<p><a href="~/jp/docs/analytics/data-visualizations/visualizations-editor.md">詳細情報</a><br />
</p></td>
...
<p><a href="~/jp/docs/analytics/data-visualizations/fields/field-settings.md">詳細情報</a><br />
</p></td>
...
<p><a href="~/jp/docs/analytics/data-visualizations/fields/field-settings.html#numeric-fields">詳細情報</a><br />
</p></td>
...
これらのダッシュボードを他のユーザーと正常に共有する方法については、[クラウド ファイルをデータ ソースとするダッシュボードを共有する](~/jp/docs/analytics/dashboards/sharing-dashboards/sharing-dashboards-datasource-files-cloud-provider.html)トピックをご覧ください。

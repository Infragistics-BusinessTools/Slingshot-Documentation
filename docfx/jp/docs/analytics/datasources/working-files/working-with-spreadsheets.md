...
<p><em>Analytics でデータを列に構成し、フィールドをスプレッドシートの最初の行によって名前を付けます。</em> データが列ではなく行で構成される場合、Analytics でフィールドの入れ替えができます。</p>
<p><a href="#列を行に転置">詳細情報</a><br />
</p></td>
...
<p><a href="~/docs/analytics/data-visualizations/fields/field-settings.md">詳細情報</a><br />
</p></td>
...
<p><a href="~/docs/analytics/data-visualizations/fields/field-settings.html#数値フィールド">詳細情報</a><br />
</p></td>
...
これらのダッシュボードを他のユーザーと正常に共有する方法については、[クラウド ファイルをデータ ソースとするダッシュボードを共有する](~/docs/analytics/dashboards/sharing-dashboards/sharing-dashboards-datasource-files-cloud-provider.md)トピックをご覧ください。

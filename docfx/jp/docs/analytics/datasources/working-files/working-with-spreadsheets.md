...
<p><a href="../../data-visualizations/fields/field-settings.md">詳細情報</a><br />
</p></td>
...
<p><a href="../../data-visualizations/fields/field-settings.md#数値フィールド">詳細情報</a><br />
</p></td>
...
これらのダッシュボードを他のユーザーと正常に共有する方法については、[クラウド ファイルをデータ ソースとするダッシュボードを共有する](../../dashboards/sharing-dashboards/sharing-dashboards-datasource-files-cloud-provider.md)トピックをご覧ください。

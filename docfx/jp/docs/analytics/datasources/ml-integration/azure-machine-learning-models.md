...
<img src="images/credit-risk-by-housing-sample-azure-machine-learning.png" alt="Credit risk by Housing example" class="responsive-img" width="85%"/>
...
2.  **表示形式エディター**で、左側の **[フィールド]** リストの上にある**脳アイコン**をクリックまたはタップします。次に、**Microsoft Azure** を選択します。

    <img src="images/azure-ml-models-brain-icon.png" alt="Brain icon location in the Visualization editor" class="responsive-img" width="85%"/>
...
1.  Azure Machine Learning Model によって公開される Web サービスにアクセスするために、以下の構成ダイアログで要求された値を提供します。
    ...
    <img src="images/microsoft-azure-connection-configuration.png" alt="MS Azure configuration dialog requested values" class="responsive-img" width="85%"/>
...
2.  表示されるダイアログで、Analytics のデータを機械学習モデルで予期される入力にマップする必要があります。
    ...
    <img src="images/input-output-microsoft-azure-ml-model.png" alt="Input list in ML model connection dialog" class="responsive-img" width="85%"/>
    ...
    b. **[出力]**: モデルで計算 (予測) する情報を選択します。結果は、表示形式エディターの新しいフィールドとして表示されます (**データ ソース: Azure model** の下)。
      ...
      <img src="images/loaded-data-from-azure-ml-model.png" alt="Data output loaded from Azure model" class="responsive-img" />

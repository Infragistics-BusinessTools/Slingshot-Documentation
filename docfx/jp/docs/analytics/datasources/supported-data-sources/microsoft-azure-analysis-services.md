...
2. **[Azure SSAS サーバーの追加]** ダイアログで、サーバーへの **URL** を指定します。
    ...
    <img src="images/add-azure-ssas-server.png" alt="Configure an Azure Analysis Services connection" class="responsive-img" />
...
<!-- <img src="images/azure-ssas-visualization-editor.png" alt="Azure SSAS data in the Visualization Editor" class="responsive-img" width="80%"/> -->
...
<img src="images/azure-ssas-my-analytics.png" alt="An Azure SSAS dashboard in a dashboard section in My Analytics" class="responsive-img" />

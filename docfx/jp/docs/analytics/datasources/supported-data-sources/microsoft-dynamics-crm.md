...
1.  データ ソースの**デフォルト名**: データ ソース名は前のダイアログのアカウントのリストに表示されます。デフォルトでは、Analytics は *Microsoft Dynamics CRM* という名前を付けます。好みに合わせて変更できます。
...
<img src="images/microsoft-dynamics-chart-types.png" alt="Microsoft Dynamics chart types" class="responsive-img" width="85%"/>

...
選択したチャート タイプに応じて、設定でさまざまな変更を行うことができます。[ここ](https://www.slingshotapp.io/en/help/docs/analytics/data-visualizations/visualizations-editor)の表示形式エディター セクションで、さまざまなチャート タイプの詳細を確認できます。

以下の例では、設定メニューから次の項目を調整できます:
- タイトルの表示
- 凡例の表示
- 開始色
- ツールチップで合計を表示

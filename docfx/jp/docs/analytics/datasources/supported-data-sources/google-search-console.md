...
<img src="./images/google-search-console-settings.png" alt="Google Search Console Visualization Editor Settings" class="responsive-img" width="80%"/>

表示形式エディターの準備ができたら、ダッシュボードを **[分析] ⇒ [ダッシュボード]**、特定のワークスペースまたはプロジェクトに保存できます。 

<img src="./images/google-search-console-my-analytics.png" alt="Google Search Console dashboard in My Analytics section" class="responsive-img" width="80%"/>

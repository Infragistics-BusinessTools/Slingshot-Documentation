...
サーバー データベースの設定に基づいて Oracle に接続するための 2 つのモジュールがあります。
  ...
  - [**SID の使用**](#sid-を使用した-oracle-への接続): Oracle データベース インスタンスの一意の名前。

  - [**サービスの使用**](#サービス-を使用した-oracle-への接続): データベース インスタンスへ接続するときに使用されるエイリアス。
...
<img src="images/add-oracle-credentials-sid.png" alt="Configure Oracle SID mode details" class="responsive-img" width="40%"/>
...
7.  準備ができたら、**[追加]** を選択してから **[サーバーの追加]** を選択します。
...
<img src="images/add-oracle-credentials-service.png" alt="Configure Oracle Service mode details" class="responsive-img" width="40%"/>
...
5.  **[資格情報]**: [資格情報] を選択した後、Oracle サーバーの資格情報を入力するか、既存の資格情報 (適用可能な場合) を選択できます。
      ...
      - **エイリアス**: データ ソース アカウントの名前。以前のダイアログのアカウントのリストに表示されます。
6. 準備ができたら、**[追加]** を選択してから **[サーバーの追加]** を選択します。
...
Analytics を使用すると、すべてのテーブルから Oracle データを取得できます。代わりに、テーブルまたはテーブルのセットからデータのサブセットを返す特定の[ビュー (英語)](https://docs.oracle.com/cd/B19306_01/server.102/b14220/objects.htm#i440066) を選択することもできます。

<img src="images/oracle-views.png" alt="Oracle views dialog" class="responsive-img" width="40%"/>

たとえば、**請求書**ビューには、データベース内のテーブルから取得した営業予測に関する情報が含まれています。

<img src="images/oracle-views-visualization-editor-example.png" alt="A dashboard sample using Oracle view data" class="responsive-img" width="70%"/>

ビューおよび Oracle の詳細については、<a href="https://docs.oracle.com/cd/B19306_01/server.102/b14220/objects.htm#i440066" target="_blank">この Web サイト (英語)</a> を参照してください。

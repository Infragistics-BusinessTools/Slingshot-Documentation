...
Microsoft Analysis Services データ ソースを構成するときにサーバー設定に基づいて使用できるモジュールが 2 つあります - [*Native*](#using-native) および [*HTTP*](#using-http)。

Native および HTTP モードの詳細については、<a href="https://docs.microsoft.com/en-us/sql/analysis-services/instances/connect-to-analysis-services?view=sql-server-2017" target="_blank">Microsoft Instance Management ヘルプ (英語)</a> をご覧ください。

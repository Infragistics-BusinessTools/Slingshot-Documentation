...
データベース **キューブ**を選択し、**[データの選択]** をクリックまたはタップして、表示形式エディターに進みます。
...
<img src="../images/ssas-dashboard-my-analytics.png" alt="Dasboard with an information from the Microsoft Analysis Services data source in My Analytics" class="responsive-img" width="85%"/>

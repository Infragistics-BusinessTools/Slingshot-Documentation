...
Slingshot ではすべてのテーブルから *Redshift* データを取得できますが、その他にもテーブルまたはテーブルのセットからデータのサブセットを返す特定の<a href="https://docs.aws.amazon.com/ja_jp/redshift/latest/dg/r_CREATE_VIEW.html" target="_blank">ビュー</a>を選択することもできます。

...
<img src="./images/linkedin-visualization-editor.png" alt="LinkedIn Visualization Editor" class="responsive-img"/>
...
- この表示形式を別のダッシュボードまたは URI に接続します。ダッシュボードをリンクする方法の詳細については、[この](https://www.slingshotapp.io/ja/help/docs/analytics/dashboards/dashboard-linking)記事をご覧ください。
...
データ ソースの詳細については、[こちら (英語)](https://www.slingshotapp.io/ja/help/docs/analytics/datasources/overview)を参照してください。
...
>[!NOTE]
>[2 要素認証](https://knowledge.hubspot.com/ja/account/how-can-i-set-up-two-factor-authentication-for-my-hubspot-login)を有効にしている場合、確認コードを入力する必要があります。
...
<img src="images/hubspot-chart-types.png" alt="List of chart types while using Hubspot as a data source" class="responsive-img" width="85%"/>

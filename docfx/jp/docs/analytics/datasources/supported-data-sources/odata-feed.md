...
保護された OData フィード データ ソースの *OAuth 2 / OIDC アカウント*を設定するには、[このトピック](~/docs/analytics/datasources/OAuth-2-OIDC-User-Authentication.md)を参照してください。
...
OData のオープン型の詳細については、<a href="https://docs.microsoft.com/ja-jp/aspnet/web-api/overview/odata-support-in-aspnet-web-api/odata-v4/use-open-types-in-odata-v4" target="_blank">こちら</a>を参照してください。

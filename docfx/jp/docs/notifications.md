...
<img class="responsive-img" src="../images/notifications-example.png" alt="Notifications panel within Slingshot" class="responsive-img" width="80%" />
...
<img class="responsive-img" src="../images/notifications-settings.png" alt="Notifications panel within the Settings menu" class="responsive-img" width="80%" />

[通知] パネルで、鉛筆アイコンを選択して各カテゴリの詳細を表示するか、カテゴリ全体のオン / オフを切り替えます。

さらに、一番下にある [デフォルトにリセット] オプションを使用して、デフォルト設定を復元できます。

<img class="responsive-img" src="../images/notifications-reset-button.png" alt="Reset to default button" class="responsive-img" width="80%" />
...
<img class="responsive-img" src="../images/notifications-overflow-settings.png" alt="Notifications overflow settings within Slingshot" class="responsive-img" width="80%" />

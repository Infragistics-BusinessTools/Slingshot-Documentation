...
ファイルにアクセスできるユーザーを表示/編集するには、**[メンバー アクセス]** をクリックまたはタップします。表示されるダイアログ (以下を参照) には、ファイルを表示および編集できるすべてのメンバー、および保留中のアクセス要求が表示されます。
...
各メンバーの名前の右側で、**[編集者/閲覧者]** > **[削除]** をクリックまたはタップしてアクセスを取り消すことができます。 
...
2. ピン固定ファイルからチャットやディスカッションを直接開始できます。ファイルのオーバーフロー メニューに **[ディスカッションの開始]** または **[チャットの開始]** オプションがあります。

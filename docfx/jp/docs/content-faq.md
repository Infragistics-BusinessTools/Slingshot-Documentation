...
ここでは、以下の 3 つの許可タイプから選択できます。
 ...
 - **アクセスを要求する** - ワークスペースのユーザーを含むすべてのユーザーは、管理者にアクセスを要求する必要があります。
...
パーソナルおよびワークスペースのクラウド ストレージのファイルはデフォルトのアプリケーションで開かれます。ただし、**[コンテンツ]** でボードにピン固定されたファイルの場合、開くために使用するアプリケーションをメニューから選択できます (以下のスクリーンショットを参照)。 

...
<img src="../images/user-account-drop-down-menu.png" alt="Settings location in a user's account" class="responsive-img" width="80%"/>
...
<img src="../images/user-settings-notifications.png" alt="Notifications Settings menu opened in Slingshot" class="responsive-img" width="80%"/>

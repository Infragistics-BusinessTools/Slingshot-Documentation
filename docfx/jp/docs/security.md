...
- **アクセスの要求** - メンバーは、ファイル所有者にファイルへのアクセスを要求する必要があります。これはデフォルトで最も制限の厳しいオプションです。つまり、初めてファイルを開こうとする人は、ファイルの管理者へのアクセスを要求する必要があります。ファイルの管理者は、アクセスを許可または拒否するように求める電子メールを受け取ります。

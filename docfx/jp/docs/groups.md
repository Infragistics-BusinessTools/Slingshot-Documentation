...
<img class="responsive-img" src="../images/groups-add-button.png" alt="Add button" class="responsive-img" width="80%"/>

3. グループの名前を入力し、メンバーを追加します。

4. 準備ができたら、**[作成]** を選択します。

<img class="responsive-img" src="../images/create-group.png" alt="New group dialog" class="responsive-img" width="80%"/>


>[!Note] **グループ**機能は *Slingshot Enterprise* ユーザーのみが利用できることに注意してください。

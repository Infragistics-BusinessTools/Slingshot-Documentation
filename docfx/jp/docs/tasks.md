...
<img class="responsive-img" src="../images/task-filter.png" width="75%" alt="New filter option">

2. フィルターの名前を追加し、フィルターに含めるものを選択します。

<img class="responsive-img" src="../images/filter-options-tasks.png" width="70%" alt="Different fields that can be added to a new filter">

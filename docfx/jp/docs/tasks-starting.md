...
<img src="../images/tasks-home.png" alt="Slingshot Home with a tasks displayed in a list" class="responsive-img"/>
...
<img src="../images/tasks-team.png" alt="Slingshot Team with a tasks displayed in a list" class="responsive-img"/>
...
In **Home**, you can access every task assigned to you under *My Tasks*. This includes personal, team, and project tasks, very useful to find all your tasks in just one place.

Within a **Project**, you get access to all the tasks created for the project, no matter who is assigned.  
Also, under *My Tasks* you can find the project tasks that are assigned to you.
...
<img src="../images/tasks-new-subtasks-fromTask.png" alt="Creating a new subtask within a Slingshot task" class="responsive-img"/>

Having the task opened also allows you to insert new subtasks as shown below.

<img src="../images/tasks-new-subtasks-others.png" alt="Other options to create a new task within a Slingshot task" class="responsive-img"/>
...
<img src="../images/tasks-filters-accessing.png" alt="Accessing task filters within Slingshot" class="responsive-img"/>
...
<img src="../images/tasks-filters-basic.png" alt="Tasks filters editor in basic mode within Slingshot" class="responsive-img"/>
...
<img src="../images/tasks-visualizations-list.png" alt="List group by options in Slingshot" class="responsive-img"/>
...
<img src="../images/tasks-visualizations-timeline.png" alt="Timeline visualization in Slingshot" class="responsive-img"/>

As shown above, you can pick a task and rearrange the start and due dates.  
In addition, you are able to change the scale (days, weeks, months) or even show/hide weekends.

<img src="../images/tasks-visualizations-timeline-settings.png" alt="Adjusting the Timeline visualization in Slingshot" class="responsive-img"/>
...
This is very important as it makes it easy for you focus on your work, not planning ahead which lists or sections you need. All this changes can happen organically and were designed to boost productivity and avoid losing time.  

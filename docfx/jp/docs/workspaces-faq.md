...
[このワークスペースで共同作業しているユーザー] ダイアログはワークスペースを作成した直後に表示されます。メンバーを招待するには、青い **[+ メンバー]** ボタンをクリック / タップします。ドロップダウンリスト (以下を参照) から組織メンバーを選択するか、上部のテキスト ボックスを使用して[個人アカウント ユーザー](roles-permissions-faq.md#組織に属さないユーザー)のメールを追加します。 
...
リストはグリッドよりもカスタマイズ可能であり、いくつかの並べ替えオプションを提供します。ストの表示タイプで、右側の<img src="../images/plus-icon.png" alt="Plus icon in Slingshot" width="25px" height="25px" />**プラス** ボタンをクリック / タップして、サブワークスペースに表示するフィールドを選択できます。  
...
ワークスペースと自分のコンテンツだけを削除するには、**抜ける**オプションを使用します。これを行うには、[ワークスペース設定] に移動し、[メンバー管理] を選択し、ロールをクリック / タップして、[ワークスペースから抜ける] を選択します。ワークスペースの唯一の管理者である場合、別のメンバーを管理者として割り当てずにワークスペースを抜けることはできません。

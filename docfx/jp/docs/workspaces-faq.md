...
リストはグリッドよりもカスタマイズ可能であり、いくつかの並べ替えオプションを提供します。ストの表示タイプで、右側の<img src="../images/plus-icon.png" alt="The Plus icon in Slingshot" width="25px" height="25px" />**プラス** ボタンをクリック / タップして、サブワークスペースに表示するフィールドを選択できます。  

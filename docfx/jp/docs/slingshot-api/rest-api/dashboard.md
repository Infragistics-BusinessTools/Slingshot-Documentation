---
title: Slingshot API – ダッシュボード オブジェクト リファレンス
_description: Slingshot ダッシュボード API オブジェクトの完全なスキーマ リファレンスです。ダッシュボードのプロパティ、タイプ、セクションとリストを使用した整理方法について学びましょう。
---
...
| dashboardSection   |オブジェクト <[DocumentInfo](../generic-slingshot-resources.md#ドキュメント情報オブジェクト)>|  read-only|

---
title: Slingshot API – ワークスペース オブジェクト リファレンス
_description: Slingshot ワークスペース API オブジェクトの完全なスキーマ リファレンスです。ワークスペースのプロパティ、ロール、ワークスペースとプロジェクト・ユーザーの関係について学びましょう。
---

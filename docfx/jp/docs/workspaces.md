...
1.  新しいワークスペースを作成するには、ワークスペース リストの上部にある左側のナビゲーションの [+ 追加] ボタンをクリック / タップします。その後、ワークスペースを最初から作成することも、[Slingshot ワークスペース テンプレート](workspace-templates.md)のいずれかを使用することもできます。

2.  ワークスペースの情報を入力し、ワークスペースのユースケースに合わないタブをオフにしてから、**[作成]** ボタンをクリック / タップします。組織の一員である場合は、ワークスペースのプライバシーを設定することもできることに注意してください。
...
1.	ワークスペース リストの上部にある左側のナビゲーションの **[+ 追加]** ボタンをクリック / タップします。

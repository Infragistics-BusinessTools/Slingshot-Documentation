...
**チャット**もコミュニケーションのツールですが、**ディスカッション**とは異なり、ワークスペースやプロジェクトとは関係ありません。つまり、Slingshot を使用して任意の Slingshot ユーザーとチャットできます。また、組織のメンバーではない個人アカウントを持つユーザーとチャットすることもできます。

...
Every *Owner* or *Contributor* of a workspace or project can create a new discussion.**組織内**のディスカッションについても同様です。 
...
ディスカッションの作成時に [通知] 機能を使用しなかった場合は、後で **@メンション** (**@ 記号**を使用してユーザー名またはメール アドレスの入力を開始) を使用できます。メンションされたユーザーにはメッセージが通知されますが、ディスカッションを**フォローする**ことを選択しない限り、新しいメッセージの通知は送信されません。

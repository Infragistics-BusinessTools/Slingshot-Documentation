...
1. Connect to a BigQuery data source. Select the dataset, which contains information necessary for your machine learning model predictions.
    ...
    Please, refer to the [Google BigQuery](~/components/analytics/datasources/supported-data-sources/google-bigquery.md)  topic for more information on the BigQuery data source.

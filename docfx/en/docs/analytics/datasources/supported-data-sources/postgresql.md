...
1.  **Default name** of the data source: Your data source name will be displayed in the list of accounts in the previous dialog. By default, Analytics names it *PostgreSQL*. You can change it to your preference.
...
#### Working with Views
With Analytics, you can retrieve PostgreSQL data from entire tables, but

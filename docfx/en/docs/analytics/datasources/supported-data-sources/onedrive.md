...
1.  You will then be notified that you will need to give some **limited permissions** to Analytics so that it can use your OneDrive data.

    <img src="images/notification-limited-permissions.png" alt="Analytics notification for giving permissions to the app" width="100%"/>
...
2.  Select *Allow* to authorize Analytics to use (read and maintain access

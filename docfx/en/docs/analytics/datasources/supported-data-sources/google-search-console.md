...
Instead of **[Fields](../../data-visualizations/fields/overview.md)** heading on the left, you’ll see two sections in their own query field.
...
2.	**Measures** (*depicted by123 icon*): They consist of numeric data. For example, you can see the number of **Clicks** by *Country Name*.

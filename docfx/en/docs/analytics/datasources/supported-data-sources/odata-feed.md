...
1.  **Default name** of the data source: Your data source name will be displayed in the list of accounts in the previous dialog. By default, Analytics names it *OData Feed*. You can change it to your preference.
...
source, please read [this topic](~/components/analytics/datasources/OAuth-2-OIDC-User-Authentication.md).

...
<img src="images/enter-Azure-SQL-details.png" alt="Opening Analytics's AzureSQL data source configuration screen" width="100%"/>
...
4.  **Credentials**: after selecting *Credentials*, you will be able to enter the credentials for Azure SQL or choose existing ones if applicable.
  ...
  - *Default name* of the data source: Your data source name will be displayed in the list of accounts in the previous dialog. By default, Analytics names it *Microsoft Azure SQL Database*. You can change it to your preference.

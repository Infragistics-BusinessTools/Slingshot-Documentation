...
<img src="./images/instagram-visualization-editor.png" alt="Instagram visualization editor" class="responsive-img" width="90%"/>
...
<img src="./images/instagram-date-range.png" alt="Instagram date range options" class="responsive-img" width="55%"/>

## Settings

Depending on the chart type you have chosen, you will be able to make different changes in the settings. You can find more information about the different chart types in the data visualizations section [here](https://www.slingshotapp.io/en/help/docs/analytics/data-visualizations/visualizations-editor).

In the example below you can adjust the following through the settings menu:
- Show Title
- Show Legend
- Start color
...
<img src="./images/instagram-dashboards.png" alt="Dashboard section with an instagram dashboard" class="responsive-img" width="90%"/>

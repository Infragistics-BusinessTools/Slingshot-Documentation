...
1.  **Default name** of the data source: Your data source name will be displayed in the list of accounts in the _Select a Data Source_ dialog. By default, Analytics names it *Amazon Athena*. You can change it to your preference.

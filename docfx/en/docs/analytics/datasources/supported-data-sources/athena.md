...
To configure an Amazon Athena data source, you will need to enter the following information:
 ...
 5. **Athena Data Source**: also known as *Data Catalog* containing databases. You can choose it from the list that will appear after you connect to your Athena account (see steps 1-3). 

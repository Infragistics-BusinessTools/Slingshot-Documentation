...
1.  **Default name** of the data source: Your data source name will be displayed in the list of accounts in the previous dialog. By default, Analytics names it *Snowflake*. You can change it to your preference.
...
1.  **Select a database** by marking the empty circle next to it:
    ...
    >[!NOTE]    
    **Snowflake sample data in Analytics**.

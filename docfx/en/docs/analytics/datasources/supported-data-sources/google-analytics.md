...
2.  **Choose an account**
    ...
    <img src="images/choose-ga-account.png" alt="Select a Google account to be used with Analytics's Google Analytics data source" width="100%"/>
...
3.  **Choose a Property**
    ...
    <img src="images/choose-ga-property.png" alt="Select a Google property to be used with Analytics's Google Analytics data source" width="100%"/>
...
4.  **Choose a database cube**
    ...
    <img src="images/choose-ga-datacube.png" alt="Select a data cube to be used with Analytics's Google Analytics data source" width="100%"/>
...
After your credentials are verified, Analytics will take you to the _Visualizations Editor_.
...
There are two *Data Filters* when using the GA data source in Analytics. 

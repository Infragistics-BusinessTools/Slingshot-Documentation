...
2.  **Choose an account**
    ...
    <img src="images/google-analytics-accounts-list.png" alt="Select a Google account to be used with Analytics's Google Analytics data source" class="responsive-img" width="55%"/>
...
3.  **Choose a Property**
    ...
    <img src="images/google-analytics-property.png" alt="Select a Google property to be used with Analytics's Google Analytics data source" class="responsive-img" width="58%"/>

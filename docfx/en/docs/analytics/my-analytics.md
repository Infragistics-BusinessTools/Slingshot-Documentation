...
2. Click/tap on **+ Data Source** in the top right corner to select the data source you want to connect.

   <img src="../../images/my-analytics-select-data-source.png" alt="Select a data source" class="responsive-img"/>

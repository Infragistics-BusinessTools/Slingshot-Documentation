...
Analytics (like a custom database or a specific file format).

In-Memory is a special type of data source that can be used only with
the SDK and not in the Analytics application out of the box. Because of
...
of Employees in the company, in order to embed a Analytics dashboard showing HR
...
3.  Create a dashboard within the Analytics app using the dummy data. Please note that you are
...
1.  Implement
    ...
    property in
    __AnalyticsSdkContextBase__, as described in [**Replacing Data Sources**](replacing-data-sources/replacing-data-sources-mssql.md).
...
__IRVDataProvider__ you need to modify your implementation of __AnalyticsSdkContextBase.DataProvider__ to return it:

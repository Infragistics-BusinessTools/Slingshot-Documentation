...
Before loading and processing the data for a dashboard (by Analytics Server
...
__IRVDataSourceProvider__
you need to modify your implementation of __AnalyticsSdkContextBase.DataSourceProvider__
to return it:

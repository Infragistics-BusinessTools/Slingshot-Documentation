...
server-side. To do this, please refer to [Enabling server-side screenshot generation](~/docs/analytics/developer/setup-configuration/setup-configuration-web.html#server-side-image-export).

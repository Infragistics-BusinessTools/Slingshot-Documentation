...
functionalities provided by Analytics’s SDK.
...
| [**In-Memory Data Support**](in-memory-data.md)                                   | Data that is part of your application and is already in memory can be used with Analytics SDK.                           |

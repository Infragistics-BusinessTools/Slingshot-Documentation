...
After getting the <a href="https://github.com/AnalyticsBi/sdk-samples-java" target="_blank" rel="noopener"> UpMedia samples </a> from GitHub, below you have detailed information to help you run them.
...
1. **Run the Spring Application**
   ...
   Analytics services can be found under */upmediabackend/reveal-api/*.

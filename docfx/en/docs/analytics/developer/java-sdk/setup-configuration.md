...
For further details about how implement your own Dashboard providers, please check our [UpMedia samples](https://github.com/AnalyticsBi/sdk-samples-java) in GitHub.
...
As said above, Analytics Java SDK is distributed as a set of [Maven](https://maven.apache.org/what-is-maven.html) modules. To work with the SDK libraries, you need to add two references and dependencies in your Maven pom.xml file.

...
All future updates and new features added to Analytics SDK will be included
here.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            When the backend is not in the same domain as the frontend and you need authentication cookies, you can request credentials using the following Web SDK setting: <b>$.ig.AnalyticsSdkSettings.requestWithCredentialsFlag = true;</b>
            </td>
        </tr>
        <tr>
            ...
            Analytics Java SDK now supports Snowflake data source connector, also including data blending between tables in the same Snowflake database.
            </td>     
        </tr>
        <tr>
            <td><i>Analytics BI Engine for Java was enhanced</i><br>
        ...
        <tr>
            ...
            Analytics now supports JAVA as another Web Server option besides .NET. The JAVA SDK requires JAVA 11+ and is distributed as a set of Maven modules. For further details, please refer to <a
        ...
        <tr>
            ...
            You can get the JAVA SDK UpMedia samples available in <a
                href="https://github.com/AnalyticsBi/sdk-samples-java">Github</a>.
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><i>[Public Bug Fix] [SDK] The server component relies on Newtonsoft.Json serializer</i><br> The Analytics
        ...
        <tr>
            ...
            <td><i>Save/Load Dashboards using JSON</i><br>You can now use Analytics SDK to save/load dashboards to/from
                JSON files.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><i>Salesforce data source enhancements</i><br>Now you can use your Salesforce reports in Analytics.</td>
        </tr>
        <tr>
            <td><i>New QuickBooks data source</i><br>Connect to your Quickbooks account and use your entities to perform
                data analysis in Analytics.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><i>Sharepoint lists and document libraries support</i><br>You can now use the metadata (name, type,
                etc.) collected for all files in a SharePoint library as a data source in Analytics.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><i>Added support for Shared Drives in Google Drive</i><br>If you have a GSuite Business account, you can
                now access your Shared Drives data and use it to build visualizations in Analytics.</td>
        </tr>
        <tr>
            <td>April-2020</td>
            <td>1.0.1136</td>
            <td><i>New Custom Theming</i><br>
                Now you can create your own theme in Analytics by configuring some or all of the customizable settings in
                the new AnalyticsTheme (Desktop) / $.ig.AnalyticsTheme (Web) class.</td>
        </tr>
        <tr>
            <td rowspan="3">Feb-2020</td>
            <td rowspan="3">1.0.981</td>
            <td><i>New Properties in AnalyticsSettings</i><br>We added multiple new properties to $.ig.AnalyticsSettings to
        ...
        <td><i>Localization Service for Analytics Desktop SDK</i><br>You can now localize titles and labels of a variety of
        ...
        <tr>
        <tr>
            <td><i>Formatting Service for Analytics Desktop SDK</i><br>You can now format numeric data, aggregated and
        ...
        <tr>
            <td><i>Changes in Setup and Configuration (Server SDK)</i><br>Analytics Server SDK now supports .NET Core 2.2+
        ...
        <td><i>Step by Step Guide</i><br>With this detailed guide, you will start with prerequisites and go through
            every step needed to setup and configure Analytics’s SDK.</td>
        <tr>
        <tr>
            <td><i>Change the Widget’s Data Source</i><br>You can now enable or disable the possibility to change a
                widget’s data source to end users. When opening the Visualization Data screen in edit mode, Analytics will
                either show or hide the change data source button in the UI.</td>
        </tr>
        <tr>
            <td><i>Formatting Service for Analytics Desktop SDK</i><br>You can now enable or disable the possibility to
                change the dashboard’s theme to end users. When entering edit mode for a dashboard, Analytics will either

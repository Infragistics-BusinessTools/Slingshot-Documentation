...
The Analytics application supports dashboard linking, which allows users to navigate through dashboards. By moving from dashboard to dashboard, you can go from a high level overview of the business' reality to a more detailed view with the specifics.
...
For further details about the Dashboard Linking functionality, refer to [**Dashboard Linking**](https://www.revealbi.io/help/dashboard-linking) from the Analytics’s User Guide.
...
revealView.VisualizationLinkingDashboard += AnalyticsView_VisualizationLinking;

//Implement the event handler
private void AnalyticsView_VisualizationLinking(object sender,

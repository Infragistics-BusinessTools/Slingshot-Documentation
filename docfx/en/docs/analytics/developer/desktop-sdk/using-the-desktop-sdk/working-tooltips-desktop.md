...
<img src="images/tooltips-sample.png" alt="Image showing Analytics's tooltips" width="100%"/>
...
- You want to display data in the tooltip that is outside of the AnalyticsView component that might be more valuable to your viewers.
...
private void AnalyticsView_TooltipShowing(object sender, TooltipShowingEventArgs e)
{

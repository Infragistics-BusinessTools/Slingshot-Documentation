...
revealView.VisualizationDataPointClicked += AnalyticsView_VisualizationDataPointClicked;
```
...
``` csharp
private void AnalyticsView_VisualizationDataPointClicked(object sender,

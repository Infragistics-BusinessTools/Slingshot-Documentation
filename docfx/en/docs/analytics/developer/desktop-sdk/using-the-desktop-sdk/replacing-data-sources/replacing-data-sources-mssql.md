...
Before loading and processing the data for a dashboard (by Analytics SDK),
...
Below you can find a list of common use cases:
  ...
  - You can replace a data source with an in-memory data source. As the
    Analytics App doesn’t support in-memory data sources, you can design a
...
property of __AnalyticsSdkSettings__:

``` csharp
AnalyticsSdkSettings.DataSourceProvider = new SampleDataSourceProvider();
```

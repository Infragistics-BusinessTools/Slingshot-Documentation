...
4.  This visualization displays the stock value for **Silver Security
    ...
    **Selected Value** to **Silver Security Corp** and *unselect
    ...
    <img src="images/SISStockValueChangeStock_All.png" alt="Updating the filter in Analytics" width="100%"/>
...
1.  Select the + button in the right corner of your dashboard, and
    ...
    **Analytics\_Dashboard\_Tutorials** spreadsheet. Then, select *Load Data*.

    <img src="images/SelectingFinanceSheet_All.png" alt="Loading data in Analytics" width="100%"/>

2.  **Open the visualizations picker** by selecting the grid icon in the top bar, and select the "Candlestick" chart.

    <img src="images/SelectCandlestickChart_All.png" alt="Selecting the Candlestick chart in Analytics" width="100%"/>
...
3.  In the Data Editor, drag and drop the **Date** field into the Label
    ...
    <img src="images/DragDropFinanceGLBFiscal_All.png" alt="Dragging and dropping fields in Analytics" width="50%"/>
...
4.  By default, the Date information in Label will be displayed in years. In order to change this, select **Date** in the Label placeholder of the data editor, and change the **Date Aggregation** to **Day**.
    ...
    <img src="images/FinanceGLBDateAggregation_All.png" alt="Changing date aggregation in Analytics" width="100%"/>
...
5.  If needed, you can remove the fraction digits in the Y axis by selecting the values in Open, High, Low and Close, and changing **Fraction Digits** to **0**.
    ...
    <img src="images/GLBFiscalRemovingFractionDigits_All.png" alt="Removing fraction digits in Analytics" width="100%"/>
...
6.  The visualization displays the GLB stock value, so **you will need to introduce a filter** for **Stocks** in order to display that particular option.
    ...
    <img src="images/GlobexCandlestickSelectValues_All.png" alt="Selecting Filters in Analytics" width="100%"/>

    There, uncheck all options and select only **Globex**.

    <img src="images/GlobexCandlestickSelectGlobex_All.png" alt="Working with filters in Analytics" width="100%"/>
...
7.  You will also need to introduce a filter in order to display information only for 2018. To do this, drag and drop **Date** into
    ...
    **Filter Type**, select **Filter by Rule**.
    ...
    <img src="images/GLBFilterbyRule.png" alt="Filtering by rule in Analytics" width="100%"/>

    Select the **Custom Date Range** rule and enter January 1st through
    December 31st.

    <img src="images/GLBEnterCustomDateRange_All.png" alt="Selecting a custom date range in Analytics" width="100%"/>
...
1.  Select the + button in the right corner of your dashboard, and
    select the **Finance Dashboard** sheet in the
    **Analytics\_Dashboard\_Tutorials** spreadsheet. Then, select *Load
    Data*.
...
2.  **Open the visualizations picker** by selecting the grid icon in the top bar, and select the "Line" chart.
    ...
    <img src="images/SelectLineChart_All.png" alt="Selecting the Line chart in Analytics" width="100%"/>
...
3.  In the Data Editor, drag and drop the **Date** field into Label,
    ...
    **Change**, **Bid** and **Offer** into **Values**.
    ...
    <img src="images/DragDropFinanceForecast_All.png" alt="Dragging and dropping fields in Analytics" width="50%"/>
...
4.  By default, the Date information in Label will be displayed in
    ...
    <img src="images/FinanceForecastDateAggregation_All.png" alt="Changing date aggregation in Analytics" width="100%"/>
...
5.  To remove the fraction digits in the Y axis, select the fields in
    ...
    <img src="images/ForecastRemovingFractionDigits_All.png" alt="Removing fraction digits in Analytics" width="100%"/>
...
2.  **Open the visualizations picker** by selecting the grid icon in the top bar, and select the "Sparkline" chart.
    ...
    <img src="images/SelectSparklineChart_All.png" alt="Selecting the sparkline chart in Analytics" width="100%"/>

3.  In the Data Editor, drag and drop the **Date** field into Date, the
    **Offer** field into **Value** and **Stocks** into Category.

    <img src="images/DragDropFinanceStockVariation_All.png" alt="Dragging and dropping fields in Analytics" width="50%"/>
...
4.  By default, the **Offer** field will be displayed as a number. In
    ...
    <img src="images/StockVariationCurrencyFormatting_All.png" alt="Changing the formatting type in Analytics" width="100%"/>
...
5.  The **Last 12 Months** chart will be displayed using a Line Chart by
    ...
    **Area**.
    ...
    <img src="images/StockVariationChangingChartType_All.png" alt="Selecting the Area chart type in Analytics" width="100%"/>
...
2.  **Open the visualizations picker** by selecting the grid icon in the top bar, and select the "Sparkline" chart.
    ...
    <img src="images/SelectLinearGauge_All.png" alt="Selecting the linear gauge in Analytics" width="100%"/>
...
3.  In the Data Editor, drag and drop the **Stocks** field into Label
    ...
    <img src="images/DragDropFinanceStockVolume_All.png" alt="Dragging and dropping fields in Analytics" width="50%"/>
...
4.  You will also need to introduce a filter in order to display
    ...
    **Filter Type**, select **Filter by Rule**.
    ...
    <img src="images/StockVolFilterbyRule_All.png" alt="Filtering by rule in Analytics" width="100%"/>

    Select the **Custom Date Range** rule and enter January 1st through
    December 31st.

    <img src="images/StockVolEnterCustomDateRange_All.png" alt="Enter custom date range in Analytics" width="100%"/>

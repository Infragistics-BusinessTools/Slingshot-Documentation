...
the beginning of this tutorial. The widget displays a [Column Chart](~/docs/analytics/data-visualizations/visualization-types/category-charts.md) and, as such, it only requires one field to be

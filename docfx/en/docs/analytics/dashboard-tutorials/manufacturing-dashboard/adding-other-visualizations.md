...
for a 12-month period arranged by worker type in a [line chart](~/components/analytics/visualization-tutorials/simple-charts.md). In order to create it:
...
12 month period in an [area chart](~/components/analytics/visualization-tutorials/simple-charts.md). In order to
create it:
...
broken down by month in a [spline chart](~/components/analytics/visualization-tutorials/simple-charts.md). In
order to create it:
...
by category in a [bar chart](~/components/analytics/visualization-tutorials/simple-charts.md). In order to create
it:
...
highest to lowest in a [column chart](~/components/analytics/visualization-tutorials/simple-charts.md). In order
to create it:

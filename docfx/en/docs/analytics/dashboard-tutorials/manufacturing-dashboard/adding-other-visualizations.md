...
for a 12-month period arranged by worker type in a [line chart](~/docs/analytics/visualization-tutorials/simple-charts.md). In order to create it:
...
12 month period in an [area chart](~/docs/analytics/visualization-tutorials/simple-charts.md). In order to
create it:
...
broken down by month in a [spline chart](~/docs/analytics/visualization-tutorials/simple-charts.md). In
order to create it:
...
by category in a [bar chart](~/docs/analytics/visualization-tutorials/simple-charts.md). In order to create
it:
...
highest to lowest in a [column chart](~/docs/analytics/visualization-tutorials/simple-charts.md). In order
to create it:

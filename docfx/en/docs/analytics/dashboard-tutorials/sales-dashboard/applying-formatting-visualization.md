...
created through the [band configurations](~/components/analytics/data-visualizations/visualization-types/gauge-charts.html#bands-configuration) in the gauge's settings.

...
<img src="images/dashboard-interactions-menu.png" alt="Accessing Analytics's Dashboard Interactions menu" width="50%"/>

  - With *Hover Tooltips* enabled, you can see **tooltips** popups when you hover over data (press and hold in touch environments).

    <img src="images/tooltips-hover.png" alt="Analytics displays tooltips when hovering over data" width="100%"/>
  ...
  - With *Crosshairs* enabled, Analytics shows crosshairs elements along
    ...
    <img src="images/crosshairs-enabled.png" alt="Analytics displays crosshairs along with tooltips" width="100%"/>
...
<img src="images/tooltips-totals.png" alt="Analytics Portrait Orientation" width="100%"/>

To enable this feature, go to *Settings* \> *Show Totals on Tooltip*,
like shown below:

<img src="images/tooltips-configuration.png" alt="Analytics Portrait Orientation" width="100%"/>

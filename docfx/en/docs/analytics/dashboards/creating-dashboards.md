...
2. You will be presented with the options to use a [dashboard template](../../dashboard-templates.md) *(See All Templates button)* or to create a new dashboard. Click/tap on the **plus icon** to create a dashboard. 

<img src="images/see-all-templates-dashboard-option.png" alt="See All Templates option for dashboards" class="responsive-img"/>
...
<img src="images/create-dashboards-chart-types.png" alt="Chart types list" class="responsive-img"/>
...
- Choose to change the dashboard's theme.
...
<img src="images/paste-option-visualization.png" alt="Paste option in the dashboard overflow menu" class="responsive-img"/>

## Applying a Theme

Once you have continued to your dashboard, you can:

1. Open its overflow menu.

2. Click/tap on **Theme**. 
...
Once your dashboard is ready, you can:

1. Click/tap on the **tick icon** in the top right-hand corner  of the dashboard or choose **Save As** from its overflow menu.

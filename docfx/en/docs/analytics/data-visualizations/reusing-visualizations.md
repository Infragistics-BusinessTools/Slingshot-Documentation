...
You can select *Rename* from the overflow menu of a visualization in [Dashboard Edit mode](~/components/analytics/dashboards/overview.md). You can also change the title in the [Visualizations Editor](~/components/analytics/data-visualizations/visualizations-editor.md) using the
*pencil icon*.

...
You can select *Rename* from the overflow menu of a visualization in [Dashboard Edit mode](~/docs/analytics/dashboards/overview.md). You can also change the title in the [Visualizations Editor](~/docs/analytics/data-visualizations/visualizations-editor.md) using the
*pencil icon*.

...
For more information on how to use your map service *authentication token* in Analytics or how to view shared maps using image tiles, read the [Using Map Image Tiles](map-image-tiles.md) topic.

...
formatting of the different ranges. In Slingshot, you can use the following gauge charts: [Linear](#linear-gauge), [Circular](#circular-gauge), [Text](#text-gauge.md), [KPI](kpi-gauge.md) and [Bullet Graph](#bullet-graph) gauges.

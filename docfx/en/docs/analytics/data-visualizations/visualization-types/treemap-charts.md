...
1. In the _Select Data Source_ dialog, choose *_Analytics Sample Data_*.

    <img src="images/data-source-reveal-sample.png" alt="Analytics Sample Data in the list of data sources" width="100%"/>
...
- **Links** - connect the visualization to a dashboard or URL. For more information, please refer to the [Linking Dashboards](~/components/analytics/dashboards/dashboard-linking.md) topic.

...
from the drop-down menu to access the *Data Filter* window.

<img src="images/data-filter-visualization-editor.png" alt="Adding data filter fields list" class="responsive-img" width="90%"/>
...
<img src="images/data-filters-values-list.png" alt="Data Filters Filtering in the Data Editor" class="responsive-img" width="90%"/>

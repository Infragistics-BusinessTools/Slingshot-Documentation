...
<img src="images/field-settings-dialog.png" alt="Sorting options in the field settings dialog" class="responsive-img"/>
...
3. **Sort by** a specific field will show under the *Sorting* setting. You can choose a field from the drop-down on the right (as shown above).
...
<img src="images/support-cases-example.png" alt="Example of a data visualization in an ascending order" class="responsive-img"/>
...
<img src="images/weekly-cases-priority.png" alt="Visualization showing weekly cases ordered by Priority level" class="responsive-img"/>
...
<img src="images/visualization-example.png" alt="Sales Info visualization while using stacked column chart" class="responsive-img"/>
...
prevail. To change the order, you can:

1. Select the **Month Name** field in the label placeholder of the data editor, and select your desired sorting.

<img src="images/field-settings-sort-by.png" alt="Sort by option with a list of different fields in the field settings dialog" class="responsive-img"/>

2. Click/tap on **Update Field**. Your information will now be ordered in chronological order.

<img src="images/financial-metrics-example.png" alt="Visualization of data sorted by chronological order" class="responsive-img"/>
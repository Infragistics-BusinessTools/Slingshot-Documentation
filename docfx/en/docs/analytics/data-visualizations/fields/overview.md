...
Field settings and rules are accessible through the [visualizations editor](~/components/analytics/data-visualizations/visualizations-editor.md), which is displayed automatically when a

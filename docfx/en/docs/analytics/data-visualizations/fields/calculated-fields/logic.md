...
You can look at these two rows only if you apply [filter by rule](~/components/analytics/data-visualizations/fields/field-filters-rules.html#rules-numeric-fields) or [select value](~/components/analytics/data-visualizations/fields/field-filters-rules.html#select-values) "1.00".

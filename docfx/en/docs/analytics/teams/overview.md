...
group of Analytics users while also ensuring a high level of security for
dashboards with sensitive information.

With Teams in Analytics, you can:
...
You can access your teams on to the left side of the screen, below the *Analytics* icon:
...
Analytics creates the Organization repository automatically when a member of your organization logs in for the first time with Office365. Members need to log in with their organization's email to be associated with an organization and added to the Organization repository.

You will find the Organization team right below the *Analytics* icon. This team is named after your organization.
...
There are three types of team members in Analytics:
...
The first user from an organization, who signs in Analytics, is given the

...
When you sign in for the first time in Slingshot with your **Office 365**
...
Depending on which account you used to sign in, you will have your OneDrive or Google Drive automatically added to your list of [data sources](https://www.slingshotapp.io/en/help/docs/analytics/datasources/overview). You will be additionally asked for **limited permissions** only the first time you use your [OneDrive](https://www.slingshotapp.io/en/help/docs/analytics/datasources/supported-data-sources/onedrive) and [Google Drive](https://www.slingshotapp.io/en/help/docs/analytics/datasources/supported-data-sources/google-drive).

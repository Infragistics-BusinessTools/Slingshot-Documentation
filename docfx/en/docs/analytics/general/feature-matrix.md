...
以下のマトリックスは、各プラットフォーム (Web、デスクトップ、iOS、Android) いおける Analytics 機能の可用性を示します。

| 機能                                           | ReportPlus                                    | Analytics                                    |
| ------------------------------------------------- | --------------------------------------------- | ----------------------------------------- |
| **データ ソース**                                  |                                               |                                           |
...
| ReportPlus クラ/Analytics リビーラーウドで共有            | <span style="color: #007F00">〇</span>       | <span style="color: #007F00">〇</span>   |
| **どこからでもアクセス**                               |                                               |                                           |
...
**注**: データベースは Analytics の Web バージョンでサポートされていません。

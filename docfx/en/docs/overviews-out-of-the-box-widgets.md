...
-	**Projects and Workspaces**: Project Timeline, Incomplete Tasks by Project
...
*Project Timeline* and *Incomplete Tasks by Projec*t widgets can only be used for **Workspace** overviews.
...
|    Widget | Use Case |
-------------------------------------------------------------------- | ------------------ | ------------------ | ------------------ |
| Tasks By Status | You want to have a clear view on your team’s task distribution. With *Tasks By Status*, you can keep an eye on the backlog tasks and the overall progress of your team. |
|Open Tasks | You have an approaching project deadline and want to prioritize your tasks. With *Open Tasks*, you can stay organized and stay ahead of your goals.|
...
|Tasks Completed Over Time |You need to track how long it takes for your team to finish a project. With Tasks Completed Over Time, you can see productivity trends and make changes if needed.|
...
|Pin from Dashboard |You want your team to create a sales report for this month and track your overall progress. You can pin the Sales dashboard you have been working on to the workspace overview so your team can have an easy access to it.|
...
|My Favorite Dashboards |You want to have quick access to your most important dashboards. You can add your favorite dashboards to your My Overview in order to make fast data-driven decisions.|
|Project Timeline |You are a part of multiple workspaces and want to monitor the progress of each of their projects. You can use the Project Timeline to plan tasks and distribute workload.|
|Incomplete Tasks By Project |You want to check the progress of each project in your workspace. With Incomplete Tasks By Project, you can manage your projects and stay ahead of your deadlines.|
|Member Tasks Summary |You want to see which assigned tasks in your workspace are approaching a deadline. You can use the Member Tasks Summary to have a quick glance on the due date of each task.|
|Member Tasks By Status |You want to assess the team’s performance. You can use the Member Tasks by Status to break down each of your team members’ contributions. |
...
|Text |You are part of different projects and workspaces, so you need a way to track all the discussions and tasks you have been mentioned in. You can use the Unread Mentions widget to prevent messages from getting lost in endless threads.|

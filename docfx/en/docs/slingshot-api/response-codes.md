...
| 400 (Bad Request) |The request was not processed because of missing or malformed parameter(s). An error array will be returned, containing information about what went wrong.|

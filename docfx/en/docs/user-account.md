...
<img src="../images/user-account-settings-drop-down-menu.png" alt="Settings location in a user's account" class="responsive-img">
...
<img src="../images/users-account-settings.png" alt="Example of user settings opened" class="responsive-img">

...
<img src="../images/projects-list.png" alt="List of the all projects in a workspace" class="responsive-img" width="90%" />

2.	Click/tap on the **+Project** button.

<img src="../images/new-project-button.png" alt="New project button" class="responsive-img" width="90%" />
...
<img src="../images/new-project-slingshot-template.png" alt="Create a new project from a template" class="responsive-img" width="90%" />
...
<img src="../images/project-template-content.png" alt="Save as template dialog for a project" class="responsive-img" width="90%" />
  ...
  - Keep  all the tasks or only the tasks structure. If you decide to keep the tasks, you can:
    ...
    <img src="../images/project-tasks-content.png" alt="Workspace template tasks options" class="responsive-img" width="90%" />
...
<img src="../images/project-template-other-content.png" alt="Workspace template tasks options" class="responsive-img" width="90%"/>
...
<img src="../images/custom-project-template-options.png" alt="Example of a stored template in a location" class="responsive-img" width="90%" />

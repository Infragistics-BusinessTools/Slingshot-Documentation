...
<img src="../images/example-task-type.png" alt="Example of a task type" class="responsive-img"/>
...
<img src="../images/organization-settings.png" alt="Organization Settings" class="responsive-img"/>

3.	Open **Task Types Library** to see the full list of task types in the organization.

<img src="../images/task-types-library-organization.png" alt="Example of a Task Types Library for an organization" class="responsive-img"/>
...
<img src="../images/manage-personal-libraries-user-settings.png" alt="Manage Personal Libraries in the user settings" class="responsive-img"/>

3.	Here you will find lists of all your personal task types, task templates, and task fields.

<img src="../images/personal-task-types-library.png" alt="Example of a personal Task Types Library" class="responsive-img"/>
...
<img src="../images/workspace-settings-overflow-menu.png" alt="Workspace Settings" class="responsive-img"/>
...
<img src="../images/workspace-task-types-library.png" alt="Example of workspace Task Types Library" class="responsive-img"/>
...
<img src="../images/button-action-option.png" alt="Button Action option" class="responsive-img"/>

3.	Click on **Task Types Library**.

<img src="../images/task-types-library-button-action.png" alt="Task Types Library option" class="responsive-img"/>

4.	Click/tap on **+Type**.

<img src="../images/new-task-type-button.png" alt="Button Action option" class="responsive-img"/>
...
<img src="../images/task-type-creation.png" alt="An example of the process of creating a task type" class="responsive-img"/>
...
<img src="../images/task-types-library-task-types-list.png" alt="Task Types Library in a list of task types" class="responsive-img"/>
...
<img src="../images/task-type-task-example.png" alt="Example of a type of a task" class="responsive-img"/>
...
<img src="../images/default-task-type-button.png" alt="Default task type button" class="responsive-img"/>
...
<img src="../images/button-action-task-list.png" alt="Button Action for a task list" class="responsive-img"/>

3.	Choose the task type that best suits your goals.

4.	You will see the new task type in the upper right corner. 

<img src="../images/default-task-type-task-list.png" alt="Default task type for a task list" class="responsive-img"/>
...
<img src="../images/convert-to-task-option.png" alt="Convert To option for a task" class="responsive-img"/>
...
<img src="../images/converted-task.png" alt="Example of a converted task" class="responsive-img"/>
...
<img src="../images/different-custom-fields-dialog-box.png" alt="Example of different custom fields" class="responsive-img"/>
...
<img src="../images/new-task-type-task.png" alt="New type for a task" class="responsive-img"/>
...
<img src="../images/convert-to-new-task-type.png" alt="Option to convert to a new task type" class="responsive-img"/>
...
<img src="../images/different-custom-fields-type.png" alt="Example of a dialog box with different custom fields for a type" class="responsive-img"/>
...
<img src="../images/subtask-create-button.png" alt="Subtask Create button" class="responsive-img"/>

4.	You will see the subtask under its parent task in the task list.

<img src="../images/subtask-parent-task.png" alt="Example of a subtask in a parent task" class="responsive-img"/>
...
<img src="../images/add-subtasks-task-overflow-menu.png" alt="Option to add subtasks to a task from its overflow menu" class="responsive-img"/>

3.	Here you can choose which task type to use for your subtask. 

<img src="../images/task-types-subtasks.png" alt="List of tasks types for new subtasks" class="responsive-img"/>

4.	Depending on which type you have selected, you will be presented with different task fields.

<img src="../images/fields-subtask.png" alt="Example of fields of a subtask" class="responsive-img"/>
...
<img src="../images/subtask-parent-task.png" alt="Example of a subtask with a type in a parent task" class="responsive-img"/>
...
<img src="../images/parent-task-manage-fields-option.png" alt="Manage fields option for a parent task" class="responsive-img"/>

3.	Open the overflow menu of *Subtasks Fields*.

4.	Click/tap on **Button Action**.

<img src="../images/button-action-subtasks-section.png" alt="Button action option in the subtasks section" class="responsive-img"/>

5.	You will be presented with a list of different task types. Choose the one that best fits your goals.

<img src="../images/subtasks-section-task-types.png" alt="List of Task Types for subtasks" class="responsive-img"/>

6.	Once you have chosen the default task type, it will show up under *Subtasks*. Click/tap on **Update** to save the changes.

<img src="../images/update-button-default-type-subtasks.png" alt="Update button for saving a default type for subtasks" class="responsive-img"/>

7.	Instead of **+Task** button for new subtasks, you will see the task type title in the parent task.

<img src="../images/new-subtasks-button.png" alt="Example of subtasks button that have a type" class="responsive-img"/>
...
<img src="../images/task-types-library-option.png" alt="Task Types Library in a list of task types" class="responsive-img"/>

3.	You will be presented with a list of task types. Open the overflow menu of the one that you want to remove.

4.	Choose **Remove**.

<img src="../images/task-type-remove-option.png" alt="Remove option for a task type" class="responsive-img"/>
...
<img src="../images/warning-remove-task-type.png" alt="A warning while removing a task type" class="responsive-img"/>
...
<img src="../images/workspace-settings-overflow-menu.png" alt="Settings option in the overflow menu of a workspace" class="responsive-img"/>

3.	Choose **Task Types Library**.

<img src="../images/task-types-library.png" alt="Example of a Task Types Library" class="responsive-img"/>

4.	Click/tap on **Remove** from the overflow menu of a type.

<img src="../images/remove-option-task-type.png" alt="Remove option for a task type" class="responsive-img"/>
...
<img src="../images/remove-task-type-warning.png" alt="A warning while removing a task type" class="responsive-img"/>

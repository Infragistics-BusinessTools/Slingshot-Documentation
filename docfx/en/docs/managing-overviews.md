...
<img src="../images/new-widget-button.png" alt="New widget buttton" class="responsive-img"/>
...
<img src="../images/widget-library.png" alt="Widget Library buttton" class="responsive-img"/>
...
<img src="../images/task-widget-maximized-mode.png" alt="Maximize mode for a task widget" class="responsive-img"/>

2.	Click/tap on the filter button next to **View**. 

<img src="../images/task-widget-filter.png" alt="Filter button" class="responsive-img"/>

3.	Select a filter value. 

4.	Choose **Apply** to save the changes.

<img src="../images/task-widget-apply-filter.png" alt="Apply filter on a task widget" class="responsive-img"/>
...
<img src="../images/task-widget-view-options.png" alt="View options for task widgets" class="responsive-img"/>
...
<img src="../images/task-widget-new-view.png" alt="Example of a new view of a task widget" class="responsive-img"/>

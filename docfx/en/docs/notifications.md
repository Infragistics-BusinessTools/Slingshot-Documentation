...
<table>
    ...
    <tr>
        ...
        <td><img src="../images/in-app-notifications-illustration.png" alt="Notifications Settings inside the Notification panel" class="responsive-img"/></td>
        <td>These notifications are displayed within the app in the <i>Notifications panel</i>.</td>
    </tr>
    <tr>
        <td><strong>Push</strong></td>
        <td><img src="../images/push-notifications-illustration.png" alt="Notifications Settings inside the Notification panel" class="responsive-img"/></td>
    ...
    <tr>
        ...
        <td><img src="../images/notifications-email-illustration.png" alt="Notifications Settings inside the Notification panel" class="responsive-img"/></td>

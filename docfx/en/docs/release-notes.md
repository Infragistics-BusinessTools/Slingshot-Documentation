...
<table class="rntable">
    ...
    <tr>
        <td><span style="font-style:italic;font-size:16px"><a href="notifications.html#choosing-what-you-see-in-the-notifications-panel">New Notifications filtering</a></span><br> In the Notifications panel, you can now choose between seeing all notifications, only unread or only your mentions. 
        </td>
    </tr>
    <tr>
        <td><span style="font-style:italic;font-size:16px"> Notifications limits removed</span><br> You now have access to your whole notifications’ history (previous show limit: last 100 notifications).
        </td>
    <tr>
        <td><span style="font-style:italic;font-size:16px"><a href="content-faq.html#can-i-change-how-boards-are-displayed">New List View for your boards</span></a><br>You can now choose between list and column view for your Boards in the Content tab. 
        </td>
    </tr>
    <tr>

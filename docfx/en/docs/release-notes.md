...
- Recurring Tasks v2: Repeating tasks now reset instead of duplicating, recurrence is supported on subtasks, and notifications are batched.
...
- Onboarding Enhancements: Adjustments made to the onboarding process based on users' feedback.
...
- [Bug Fix] Chat Attachment Display: When starting a chat with an attachment, the chat would appear empty until re-navigating back to the chat.
...
- [Bug Fix] A request access dialog would show up when mentioning someone who already had access to a discussion.

- [Bug Fix] *Calendar view* would show an incorrect date. 

- [Bug Fix] *Dashboard Filter* was displayed during load of filters.

- [Bug Fix] Deleted messages would show up in the search results.
 
- [Bug Fix] Notifications would appear hidden when another notification was being expanded.

- [Bug Fix] When adding a dashboard directly in the data catalog, the organization would show up twice.

- [Bug Fix] When choosing *End date* for a project, the *Due Date* would show up instead.
